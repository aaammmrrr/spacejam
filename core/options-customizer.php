...
function cyberchimps_customize( $wp_customize ) {
	...
	class Cyberchimps_Background_Image extends WP_Customize_Control {
		...
		public function render_content() {
			...
			<span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
			<em>
				<small><?php _e( 'make sure you have removed the image above before selecting one of these', 'compact-one' ); ?></small>
			</em>
			<?php
			foreach ( $this->choices as $value => $label ) :
	...
	class Cyberchimps_skin_selector extends WP_Customize_Control {
		...
		public function render_content() {
			...
			$wp_customize->add_control(
				'custom_logo_url', array(
					'label' => __( 'Custom Logo URL', 'compact-one' ),
			...
			$wp_customize->add_control(
				'custom_logo_url_link', array(
					'label' => __( 'Enter Custom Logo URL', 'compact-one' ),
					'section' => 'title_tagline',
			...
			$wp_customize->add_section(
				'cyberchimps_social_media', array(
					...
					'theme_supports' => '',
					'title' => __( 'Social Option', 'compact-one' ),
				)
			);
				...
				$wp_customize->add_control(
					new Cyberchimps_skin_selector(
						$wp_customize, 'theme_backgrounds', array(
							'label' => __( 'Choose your icon style', 'compact-one' ),
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'social_facebook', array(
						'label' => __( 'Display Facebook?', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'facebook_url', array(
						'label' => __( 'Facebook URL', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'social_twitter', array(
						'label' => __( 'Display Twitter?', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'twitter_url', array(
						'label' => __( 'Twitter URL', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'social_google', array(
						'label' => __( 'Display Google?', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'google_url', array(
						'label' => __( 'Google+ URL', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
						'settings' => 'google_url',
					)
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'social_linkedin', array(
						'label' => __( 'Display LinkedIn?', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'linkedin_url', array(
						'label' => __( 'LinkedIn URL', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'social_youtube', array(
						'label' => __( 'Display Youtube?', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'youtube_url', array(
						'label' => __( 'Youtube URL', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'social_flickr', array(
						'label' => __( 'Display Flickr?', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'flickr_url', array(
						'label' => __( 'Flickr URL', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
						'settings' => 'flickr_url',
					)
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'social_pinterest', array(
						'label' => __( 'Display Pinterest?', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'pinterest_url', array(
						'label' => __( 'Pinterest URL', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'social_googlemaps', array(
						'label' => __( 'Display Google Maps?', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'googlemaps_url', array(
						'label' => __( 'Google Maps URL', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'social_email', array(
						'label' => __( 'Display Email?', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'email_url', array(
						'label' => __( 'Email Address', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
						'settings' => 'email_url',
					)
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'social_rss', array(
						'label' => __( 'Display RSS?', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
						'settings' => 'social_rss',
						'type' => 'checkbox',
					)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'social_instagram', array(
						'label' => __( 'Display Instagram?', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize, 'instagram_url', array(
						'label' => __( 'Instagram URL', 'compact-one' ),
						'section' => 'cyberchimps_social_media',
			...
			$wp_customize->add_control(
				'footer_copyright_text', array(
					'label' => __( 'Footer Copyright Text', 'compact-one' ),
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					$wp_customize, 'text_colorpicker', array(
						'label' => __( 'Text Color', 'compact-one' ),
						'section' => 'colors',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					$wp_customize, 'link_colorpicker', array(
						'label' => __( 'Link Color', 'compact-one' ),
						'section' => 'colors',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					$wp_customize, 'link_hover_colorpicker', array(
						'label' => __( 'Link Hover Color', 'compact-one' ),
						'section' => 'colors',
			...
			$wp_customize->add_section(
				'cyberchimps_typography_section', array(
					'title' => __( 'Typography', 'compact-one' ),
					'priority' => 40,
				)
			);
			...
			$wp_customize->add_control(
				new Cyberchimps_Typography_Size(
					$wp_customize, 'typography_size', array(
						'label' => __( 'Typography Size', 'compact-one' ),
			...
			$wp_customize->add_control(
				'typography_style', array(
					'label' => __( 'Typography Style', 'compact-one' ),
					'section' => 'cyberchimps_typography_section',
					'type' => 'select',
			...
			$wp_customize->add_control(
				'typography_face', array(
					'label' => __( 'Typography Face', 'compact-one' ),
					'section' => 'cyberchimps_typography_section',
					'type' => 'select',
			...
			$wp_customize->add_control(
				'google_font_field', array(
					'label' => __( 'Enter Google font', 'compact-one' ),
					'section' => 'cyberchimps_typography_section',
					'type' => 'text',
			...
			$wp_customize->add_control(
				'font_family_headings', array(
					'label' => __( 'Font Family for headings', 'compact-one' ),
					'section' => 'cyberchimps_typography_section',
					'type' => 'select',
			...
			$wp_customize->add_control(
				'google_font_headings', array(
					'label' => __( 'Google font for headings', 'compact-one' ),
					'section' => 'cyberchimps_typography_section',
					'type' => 'text',
			...
			'label' => 'CyberChimps ' . __( 'Background Image', 'compact-one' ),
