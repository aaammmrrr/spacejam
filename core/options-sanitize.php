...
function cyberchimps_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'compact-one' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'compact-one' ),
		'repeat-y'  => __( 'Repeat Vertically', 'compact-one' ),
		'repeat'    => __( 'Repeat All', 'compact-one' ),
	);
...
function cyberchimps_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'compact-one' ),
		'top center'    => __( 'Top Center', 'compact-one' ),
		'top right'     => __( 'Top Right', 'compact-one' ),
		'center left'   => __( 'Middle Left', 'compact-one' ),
		'center center' => __( 'Middle Center', 'compact-one' ),
		'center right'  => __( 'Middle Right', 'compact-one' ),
		'bottom left'   => __( 'Bottom Left', 'compact-one' ),
		'bottom center' => __( 'Bottom Center', 'compact-one' ),
		'bottom right'  => __( 'Bottom Right', 'compact-one' ),
	);
...
function cyberchimps_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'compact-one' ),
		'fixed'  => __( 'Fixed in Place', 'compact-one' ),
	);
...
function cyberchimps_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'compact-one' ),
		'italic'      => __( 'Italic', 'compact-one' ),
		'bold'        => __( 'Bold', 'compact-one' ),
		'bold italic' => __( 'Bold Italic', 'compact-one' ),
	);
