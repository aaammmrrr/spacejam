...
if ( ! function_exists( 'cyberchimps_posted_by' ) ) {
	function cyberchimps_posted_by() {
		...
		$posted_by = sprintf(
			...
			'<span class="byline"> ' . __( 'by %s', 'compact-one' ),
...
if ( ! function_exists( 'cyberchimps_post_tags' ) ) {
	...
	function cyberchimps_post_tags() {
		...
		if ( $tags_list ) :
			...
			$tags = sprintf( __( 'Tags: %s', 'compact-one' ), $tags_list );
			?>
			<span class="taglinks">
...
if ( ! function_exists( 'cyberchimps_post_comments' ) ) {
	...
	function cyberchimps_post_comments() {
		...
		?>
			<span class="comments-link"><?php comments_popup_link( $leave_comment, __( '1 Comment', 'compact-one' ), '% ' . __( 'Comments', 'compact-one' ) ); ?></span>
	...
	?>
		<div class="featured-image">
			<a href="<?php the_permalink(); ?>" title="<?php
											...
											printf( esc_attr__( 'Permalink to %s', 'compact-one' ), the_title_attribute( 'echo=0' ) );
											?>" rel="bookmark">
